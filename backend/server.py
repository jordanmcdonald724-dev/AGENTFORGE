...
# Import all Pydantic models from models module
from models import (
    Agent, Project, Task, Message, ProjectFile, GeneratedImage, ProjectPlan,
    AgentMemory, CustomQuickAction,
    ProjectCreate, ChatRequest, ImageGenRequest, FileCreate, FileUpdate,
    TaskCreate, PlanApproval, GitHubPushRequest, AgentChainRequest,
    RefactorRequest, ProjectDuplicateRequest, CustomActionCreate, MemoryCreate,
    QuickActionRequest,
    SimulationRequest, SimulationResult, AutonomousBuild, WarRoomMessage,
    StartBuildRequest, PlayableDemo, BuildWorker, BuildFarmJob, BuildQueueItem,
    DebugLoop, Checkpoint, IdeaConcept, IdeaBatch, SaaSBlueprint, SystemMap,
    BlueprintNode, Blueprint, Collaborator, FileLock, CollaborationMessage,
    NotificationSettings, AudioAsset, Deployment, SandboxSession, SandboxConfig,
    PipelineAsset, AssetImportRequest, ProjectAutopsy, DynamicAgent,
    GoalLoop, KnowledgeEntry, ArchitectureVariant, ArchitectureExploration,
    RefactorJob, MissionControlEvent, DeploymentPipeline, SystemModule,
    RealityPipeline
)

# Import core utilities and agents configuration
from core.agents import AGENT_CONFIGS, DELEGATION_KEYWORDS, PROJECT_THUMBNAILS
...
# All Pydantic models are now in /app/backend/models/ directory
# See: models/base.py, models/project.py, models/build.py, models/collaboration.py,
#      models/sandbox.py, models/autopsy.py, models/agent.py, models/v45_features.py

# ============ CONSTANTS ============
# Constants needed by server.py (kept here for now)
...
# Agent configuration and helper functions moved to core/agents.py and core/helpers.py
# ============ API ROUTES ============
...
# NOTE: Autonomous Builds routes extracted to /routes/autonomous_builds.py
# Routes handled by modular router:
