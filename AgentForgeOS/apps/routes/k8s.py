...
async def get_k8s_status():
    ...
    from services.k8s_scaling import k8s_scaler
...
async def get_manifests():
    ...
    from services.k8s_scaling import generate_all_manifests
...
async def download_manifests():
    ...
    from services.k8s_scaling import export_manifests
    import shutil
...
async def get_manifest_yaml(filename: str):
    ...
    from services.k8s_scaling import (
